...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <p class="style16">
        ...
        <span class="style19">
        <span style="color: red"><span class="style22">The reservations must be made no later than 6/26/14</span></span><span 
            class="style22"><o:p>. </o:p>
    </p>
    <p class="style16">
    ...
    <p class="style16">
        ...
        indoor pool, hot tub, and exercise room.</span></span><o:p></o:p></p>
    <p class="style16">
        <o:p></o:p>
    ...
    <p class="style16">
        <span class="style21">This hotel has rooms for us starting 7/24/14 and departing 7/28/14.
    ...
    <p class="style16">
        ...
        Cancellation policy is: Can cancel up to 6:00pm the day of arrival. Hotel has an 
        outside patio, inside pool, hot tub, and large exercise room.</span><o:p></o:p></p>
    <p class="style3">           
