...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="style1">
        <br />
        <span class="style15">The Venue - HR Mansion</span><br />
        <br />
        ...
        <br />
        <strong><span class="style22">The Carriage Room</span></strong><br />
        <img class="style19" src="IMAGES/CarriageHouse.JPG" /><br />
        <br />
        <span class="style21"><strong>The Back Lawn</strong></span><br />
        <img class="style20" src="IMAGES/backLawn.JPG" /></div>
</asp:Content>
